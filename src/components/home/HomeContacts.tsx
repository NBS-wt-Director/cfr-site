    ...
    <section id="contacts" className={styles.contacts}>
      <div className="max-w-[95vw] mx-auto px-4">
        <div className="text-center mb-20">
          <h2 className="text-[24px] md:text-[24px] font-black bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow-2xl">
            Контакты
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <a href={`tel:${contacts.phone.replace(/\D/g, '')}`} className={styles.contactItem}>
              <h3>📞 Телефон</h3>
              <p className="font-bold text-button">{contacts.phone}</p>
            </a>
          </div>
