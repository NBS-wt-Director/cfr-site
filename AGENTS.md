...
**Всегда используй Webpack:**
```json
"build": "next build --webpack",
"start": "next start --no-turbopack -p 3000"
```

Если `next build` падает с ошибкой `Parsing CSS source code failed` — это Turbopack.

### 2. API маршруты — новый синтаксис
